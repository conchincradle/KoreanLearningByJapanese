...
import com.example.koreanlearningbyjapanese.Constants
import com.example.koreanlearningbyjapanese.Question
import com.example.koreanlearningbyjapanese.R
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        ...
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            //  (Now remove the toast message and launch the result screen which we have created and also pass the user name and score details to it.)
                            // START
                            val intent =
